...
<body>
    ...
    <div class="grid grid-cols-3 grid-rows-3 ">
        ...
        <aside id="cta-button-sidebar" class=" flex-initial w-20 h-screen transition-transform -translate-x-full sm:translate-x-0 col-span-1" aria-label="Sidebar">
        ...
        <div class="shopping_list p-8 flex flex-col content-center items-center">
            <div class="add_item flex justify-center rounded-3xl">
                <div class="add_item rounded-3xl text-white w-3/4 h-40 grid grid-cols-2 relative justify-center ">
                    <div class="wine-bottle absolute bottom-10 start-8 col-start-1">
                        <svg width="81" height="135" viewBox="0 0 81 135" fill="none" xmlns="http://www.w3.org/2000/svg" class="">
                    ...
                    <div class="p-6 col-end-10">
                        ...
                        <button class="w-32 p-3 bg-white text-black rounded-lg hover:bg-slate-100 mt-4 font-bold" type="submit">Add item</button>
                    </div>
