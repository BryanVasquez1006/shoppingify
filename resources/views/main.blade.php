...
<body>
    ...
    <div class="flex justify-between">
        ...
        <div class="items flex-grow p-6">
            ...
            <div>
                <h2 class="a font-bold text-lg mt-10">Fruits and vegetables</h2>
                <div class="grid grid-cols-4 gap-3">
                    <div class=" border- p-3 border rounded-lg drop-shadow-md font-bold flex justify-between ">
                        <p>Avocado</p>
        ...
        <div class="shopping_list p-10 flex flex-col content-center ">
            ...
            <div class="item flex justify-between">
                ...
                <span
                    class=" border-orange-300 text-orange-400 border-2 p-3 rounded-full content-center w-24 text-center">3
                    pcs</span>
            </div>
